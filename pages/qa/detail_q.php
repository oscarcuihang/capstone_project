...
<div class="wrap">
    ...
    <div class="container mt30">
                ...
                <article class="widget-question__item">
                    <div class="post-col">
                        <div class="widget-vote">
                            ...
                            <span class="count">-7</span><!--问题的rating显示在这里-->
                    ...
                    <div class="post-offset">
                        ...
                        <div class="question fmt">
							<p>感觉所有js代码都曝露出来，辛苦做出来的代码很快被人抄袭，怎么可以隐藏一下呢</p><!--问题的text内容就写在这里-->
						</div>
          </div><!-- end .post-offset -->
                </article>
        ...
        <h2 class="title h4 mt30 mb20 post-title" id="answers-title">9 个回答</h2><!--一共有多少个回答数目-->
...
<article class="clearfix widget-answers__item" id="a-1020000002706369">
    ...
    <div class="post-offset">
		...
		<!--pomoho:username  声望值：4//其实可以不用这个声望值-->
        <span class="ml10 text-muted">
            2 天前 回答<!--记录回答时间-->
        </span>
...
<article class="clearfix widget-answers__item" id="a-1020000002707962">
    <div class="post-col">
        <div class="widget-vote">
            <!--show average rating for answer-->
            <span class="count">0</span>
        </div>
    </div>
    ...
    <div class="post-offset">
        ...
        <form action="/question/1010000002706115/answers/add" method="post" class="editor-wrap">
            <div class="editor" id="questionText">
                <textarea id="answerEditor" name="text" class="form-control" rows="4" placeholder="Give Your Answer..." ></textarea>
            </div>
            <div id="answerSubmit" class="mt15 clearfix">
                ...
                <div class="pull-right">
                    ...
                    <a id="dropIt" href="javascript:void(0);" class="mr10">
                        [Give Up]
                    </a>
                    <button type="submit" id="answerIt" data-id="1010000002706115" class="btn btn-lg btn-primary ml20">Submit!</button>
                </div>
            </div>
        </form>
...
+'e50'//'2'
+'a'//'j0j'
, _log = [[8,9],[9,12],[23,24],[28,31],[28,31],[28,31]];

    for (var i = 0; i < _log.length; i ++) {
        _iit8vce = _iit8vce.substring(0, _log[i][0]) + _iit8vce.substring(_log[i][1]);
    }
